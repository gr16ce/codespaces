...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/assets/style.css?ver<?php date('His');?>" media="all" />
        ...
        <div id="main" class="about">
            ...
            <div class="about__container">
                ...
                <div class="about__right">
                    <h1>About Me</h1>
                    <h3 class="about-name">Elizabeth Saufley</h3>
                    <p>Hello and welcome to my page! I would like to tell you a little bit about myself. I like to read and listen to murder mystery books, and love to ride horses. I also enjoy playing volleyball. I also plan to go to college for Equine schooling. 
